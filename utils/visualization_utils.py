...
STANDARD_COLORS = [
    ...
    'DeepPink', 'PowderBlue', 'DodgerBlue', 'FireBrick', 'FloralWhite',
    ...
    'Red', 'RosyBrown', 'DodgerBlue', 'SaddleBrown', 'Green', 'SandyBrown',
    'SeaGreen', 'SeaShell', 'Sienna', 'Silver', 'SkyBlue', 'SlateBlue',
    'SlateGray', 'SlateGrey', 'Snow', 'SpringGreen', 'SteelBlue', 'GreenYellow',
    'Teal', 'Thistle', 'Tomato', 'Turquoise', 'Teal', 'Wheat', 'White',
    'WhiteSmoke', 'Yellow', 'YellowGreen'
]

#BlueViolet, DarkOrchid, DarkViolet, Fuchsia, ForestGreen,lb
EGAT_COLORS = [
    'Lime', 'Chartreuse', 'LightGrey', 'LightGrey', 'LightSteelBlue','Gainsboro','SeaShell'
]
    ...
    if scores is None or scores[i] > min_score_thresh:
      ...
      if scores is None:
        ...
        if agnostic_mode:
          ...
          '''
          box_to_color_map[box] = EGAT_COLORS[classes[i]]
